...
//			select ".bss.Cpu0_Main.g_AppCpu0";
			...
			select ".bss.LQ_SmartCar.g_adc0Data";
			select ".bss.LQ_SmartCar.g_adc1Data";
			select ".bss.LQ_SmartCar.g_adc2Data";
			select ".bss.LQ_SmartCar.g_adc3Data";
			select ".bss.LQ_SmartCar.g_adc4Data";
			select ".bss.LQ_SmartCar.g_adc5Data";
			select ".bss.LQ_SmartCar.g_acor1";
			select ".bss.LQ_SmartCar.g_acor2";
			select ".bss.LQ_SmartCar.g_acor3";
